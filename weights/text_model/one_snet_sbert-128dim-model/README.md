...
`torch.utils.data.dataloader.DataLoader` of length 102340 with parameters:
```
...
SentenceTransformer(
  ...
  (2): Normalize()
  (dense): Dense({'in_features': 384, 'out_features': 128, 'bias': True, 'activation_function': 'torch.nn.modules.activation.Tanh'})
)
```
